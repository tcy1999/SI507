...
% Student Name: Chenyun Tao

% Student Unique Name: cyuntao
...
def make_move(player, board):
    ...
    '''
    while True:
        move = input("{}'s move: ".format(player_name(player)))
...
def check_win_horizontal(board):
    """check a board horizontally to see if there is a winner

    delegates to functions that check horizontally to see if there is a winner. Returns the first winner
...
def check_win_vertical(board):
    """check a board vertically to see if there is a winner

    delegates to functions that check vertically to see if there is a winner. Returns the first winner
    found in the case of multiple winners.
...
def check_win_diagonal(board):
    """check a board diagonally to see if there is a winner

    delegates to functions that check diagonally to see if there is a winner. Returns the first winner
    found in the case of multiple winners.
...
display_board(board)
print('Game over! {} wins!'.format(player_name(winner)))
